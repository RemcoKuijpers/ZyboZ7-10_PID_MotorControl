...
HD_PWD='/home/remco/Final_Project_AES/Final_Project_AES.runs/Block_Diagram_quadrature_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_quadrature_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Diagram_quadrature_decoder_0_0.tcl
