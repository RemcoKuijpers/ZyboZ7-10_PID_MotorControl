...
HD_PWD='/home/remco/Final_Project_AES/Final_Project_AES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Block_Diagram_wrapper.tcl -notrace
