...
# module references:
# PID, clk_div, invert_top, pwm, quadrature_decoder
...
proc create_root_design { parentCell } {
  ...
  set Direction [ create_bd_port -dir O -from 0 -to 0 Direction ]
  set InvDirection [ create_bd_port -dir O -from 0 -to 0 InvDirection ]
  ...
  set block_name quadrature_decoder
  set block_cell_name quadrature_decoder_0
  if { [catch {set quadrature_decoder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $quadrature_decoder_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins quadrature_decoder_0/a]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins quadrature_decoder_0/b]
  connect_bd_net -net PID_0_dir [get_bd_ports Direction] [get_bd_pins PID_0/dir] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins invert_top_0/PB]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins quadrature_decoder_0/set_origin_n]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins PID_0/kp_den] [get_bd_pins axi_gpio_2/gpio2_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins PID_0/kp_num] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_pins PID_0/ki_den] [get_bd_pins axi_gpio_3/gpio2_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins PID_0/ki_num] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_gpio_4_gpio2_io_o [get_bd_pins PID_0/kd_den] [get_bd_pins axi_gpio_4/gpio2_io_o]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins PID_0/kd_num] [get_bd_pins axi_gpio_4/gpio_io_o]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins PID_0/SetVal] [get_bd_pins axi_gpio_5/gpio_io_o]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins PID_0/on_off_switch] [get_bd_pins axi_gpio_6/gpio_io_o]
  connect_bd_net -net clk_div_0_clk_out [get_bd_pins PID_0/clk] [get_bd_pins clk_div_0/clk_out]
  connect_bd_net -net invert_top_0_LED [get_bd_ports InvDirection] [get_bd_pins invert_top_0/LED]
  connect_bd_net -net pid_0_Power [get_bd_pins PID_0/output] [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins pwm_0/duty]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins clk_div_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_0/clk] [get_bd_pins quadrature_decoder_0/clk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pwm_0_pwm_out [get_bd_ports pwm] [get_bd_pins pwm_0/pwm_out]
  connect_bd_net -net quadrature_decoder_0_pos [get_bd_pins PID_0/adc_data] [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins quadrature_decoder_0/pos]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins PID_0/kd_sw] [get_bd_pins PID_0/ki_sw] [get_bd_pins PID_0/kp_sw] [get_bd_pins pwm_0/ena] [get_bd_pins pwm_0/reset_n] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins clk_div_0/reset] [get_bd_pins xlconstant_1/dout]
